...
`plan-full-translation-installation`은 지원 일본판 원본과 누적 후보를 결속해 13개 필수 번역 도메인, 504개 대사 레코드, 928개 페이지 작업집합을 하나의 통합 개발 ROM에 설치한다. 현재 정확 출력 SHA-1은 `3c8c86110451b7b9177eb554500ea2b5e5353a6e`, SHA-256은 `ac05641f489e42584703c4eb254d151985486becf7da21a383912b47fa3530e4`다. 정적 소비자 결속은 **13 / 13**이며 원본 영어 `MAP`, `LV`, `HP`, `STR`, `SKI`, `WLV`, `AGI`, `DEF`, `MOV`, `H.P`, `EXP`, `NEXT STORY`, 숫자와 `※`는 보존한다.

...
pub(super) fn plan_dialogue_runtime_state_storage(
    ...
    Ok(DialogueRuntimeStateStoragePlan {
        ...
        ownership_lifetime: "main dialogue active plus an E7-suspended resident page, a completed page retained only by source-bound storage composite states 1D/23, or from a non-dialogue composite publication through immediate selection, screen open, redraw, and screen close; open consumes its publication, close clears redraw state, and source/concurrent writers exclude the whole range",
        ...
        runtime_lifecycle_contract: RuntimeLifecycleContract {
            ...
            ownership_continue: "E4, E6, visible-page transitions, E7 suspension, and terminal suspension selected by source-bound storage composite states 1D/23 retain ownership while no shared CHR-RAM writer has invalidated it",
            ownership_invalidate: "a new dialogue request, terminal selection outside storage states 1D/23, battle CHR-RAM composition, reset, save/load boundary, and unclassified inactive writers invalidate selection or stored material",

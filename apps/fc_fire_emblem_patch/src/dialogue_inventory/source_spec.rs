...
pub(super) const MAIN_DIALOGUE_STATE_CODE_REGIONS: [CodeRegionSpec; 11] = [
    CodeRegionSpec {
    ...
    CodeRegionSpec {
        role: "publish_optional_E8_composite_and_display_flags",
        cpu_address: 0x8168,
        bytes: &[
            0xA9, 0x20, 0x20, 0x90, 0xE6, 0xA9, 0x01, 0x8D, 0x1E, 0x78, 0x8D, 0x31, 0x78,
        ],
    },
    CodeRegionSpec {

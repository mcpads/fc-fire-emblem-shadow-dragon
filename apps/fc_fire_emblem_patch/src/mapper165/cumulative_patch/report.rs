...
pub(super) struct CumulativeTitleLogoReport {
    ...
    pub(super) installed_runtime_overlay_cell_count: usize,
    pub(super) installed_runtime_overlay_stream_sha1: String,
    pub(super) preserved_title_stream_bytes_unchanged: bool,
    pub(super) preserved_runtime_overlay_control_bytes_unchanged: bool,

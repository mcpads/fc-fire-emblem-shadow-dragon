...
pub(crate) const SAVE_OFFER_FIXED_STRING_INDEX: u8 = 0x32;
...
pub(super) const OUTER_SCREEN_STATE_HANDLERS: [u16; 16] = [
    0x8425, 0x842B, 0x849D, 0x850B, 0x8511, 0x8527, 0x85BD, 0x8890, 0x8923, 0x8934, 0x894C, 0x894F,
    0x8957, 0xB5AC, 0xB771, 0xB7EE,
];
...
pub(super) const OPEN_SAVE_COMPLETE_CONTINUE_PROMPT_BYTES: &[u8] = &[
    0xA9, 0x00, 0x85, 0xD1, 0x8D, 0xF1, 0x77, 0x8D, 0xF0, 0x77, 0xA9, 0xB0, 0x8D, 0xF4, 0x77, 0xA9,
    0x01, 0x8D, 0xF7, 0x77, 0xEE, 0xEE, 0x05, 0x60,
];

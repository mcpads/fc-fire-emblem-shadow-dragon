...
pub(super) struct EndingCharacterEpilogueTranslationSurface {
    ...
    table_selector_address_hex: String,
    entry_selector_address: u16,
    entry_selector_address_hex: String,
...
pub(super) fn bind_ending_character_epilogue(
    ...
    Ok(EndingCharacterEpilogueTranslationSurface {
        ...
        table_selector_address: MAIN_DIALOGUE_RUNTIME_STATE.directory_selector_address,
        table_selector_address_hex: format!(
            "0x{:04X}",
            MAIN_DIALOGUE_RUNTIME_STATE.directory_selector_address
        ),
        entry_selector_address: MAIN_DIALOGUE_RUNTIME_STATE.entry_index_address,
        entry_selector_address_hex: format!(
            "0x{:04X}",

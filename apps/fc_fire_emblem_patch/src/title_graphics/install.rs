...
pub(crate) const TITLE_RUNTIME_COMPLETION_STREAM_BYTE_COUNT: usize = 55;
const TITLE_RUNTIME_CLEARED_TOP_STRIP_CELL_COUNT: usize = 26;
const TITLE_RUNTIME_REASSERTED_LOGO_CELL_COUNT: usize = 11;
const SOURCE_TITLE_RUNTIME_COMPLETION_STREAM: [u8; TITLE_RUNTIME_COMPLETION_STREAM_BYTE_COUNT] = [

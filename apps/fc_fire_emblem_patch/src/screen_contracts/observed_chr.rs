...
pub(crate) const OBSERVED_CHR_PAIRS: &[ObservedChrPair] = &[
    ...
    pair("item_transfer_result", PatternWindow::Left, 0x1C, 0x1C),
    pair("item_transfer_result", PatternWindow::Right, 0x00, 0x18),
    pair("item_discard_result", PatternWindow::Left, 0x1C, 0x1C),
    pair("item_discard_result", PatternWindow::Right, 0x00, 0x19),
    ...
    pair("suspend_message", PatternWindow::Left, 0x1C, 0x1C),
    pair("suspend_message", PatternWindow::Right, 0x00, 0x19),
    pair("unit_selection", PatternWindow::Left, 0x1A, 0x1A),
    pair("unit_selection", PatternWindow::Left, 0x18, 0x18),
    pair("unit_selection", PatternWindow::Right, 0x00, 0x19),
    pair("game_speed_selection", PatternWindow::Left, 0x1A, 0x1A),
    ...
    pair("storage_capacity_notice", PatternWindow::Right, 0x00, 0x18),
